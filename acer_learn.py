...
def main(total_timesteps,alpha,gamma):
    ...
    logger.configure(dir="./logs/acer", format_strs=['stdout', 'log', 'csv', 'tensorboard'])

    env = make_aai_env("AnimalAI/AnimalAI", 1, arenas_configurations)
    act = acer.learn(env=env, network="cnn", total_timesteps=total_timesteps, lr=alpha, gamma=gamma)
...
if __name__ == "__main__":
    ...
    # python -i .\acer_learn.py 80000000 0.0001 0.99